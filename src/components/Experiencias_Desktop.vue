    ...
    >
      ...
      >
        <v-row
          ...
          @click="whatsapp"
        >
          <p class="ma-0 ml-5 pa-0">WHATSAPP</p> <v-icon class="ma-0 ml-12 mr-5 pa-0" size="40">$camion</v-icon>
        </v-row>
      ...
      >
        ...
        >
          <v-row
            class="ma-0 pa-0"
            style="max-width:40%;border-bottom: 1px solid grey"
          >
        ...
        <v-row
          class="ma-0 pa-0"
          style="font-family:Space Grotesk;height:350px"
          justify="center"
          align="center"
        >
          <v-row
            class="ma-0 mt-12 pa-0"
            style="max-height:20px;width:100%;font-size:35px;font-weight:300;color:#101010"
            justify="center"
          >
            EN QUÉ ESTAMOS
          </v-row>
        ...
        >
          <v-row
            class="ma-0 pa-0"
            style="max-width:40%;border-top: 1px solid grey"
          >
