  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <VideoParallax class="ma-0 mx-6 pa-0" style="width:100%;min-height:60vh" src="videos/lab.mov">
          ...
          <v-row
            ...
            style="position:absolute;width:100%;height:393px"
          >
            <v-carousel
              hide-delimiters
              :show-arrows="false"
            ...
            >
              <v-carousel-item
                ...
                style="font-size:65px;font-family:Space Grotesk;font-weight:700;width:100vw"
              >
                <v-row
                ...
                >
                  <v-row
                    class="ma-0 pa-0"
                    style="max-width:70%;min-height:25vh;line-height:55px;color:white"
                    align="center"
                  >
                    <p class="ma-0 pa-0">{{ item }}</p>
                  </v-row>
                </v-row>
              </v-carousel-item>
            </v-carousel>
